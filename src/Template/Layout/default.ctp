...
//Ajout des scripts Bootstrap, jquery et Angular.js
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?= $this->Html->link(__('Customers (Monopage)'), ['controller' => 'Customers', 'action' => 'index'], ['class' => 'dropdown-item']) ?>
                        ...
                        <?php if ($loguser && $role === 3): ?>
                            ...
                            <?= $this->Html->link(__('Admin panel: Users'), ['controller' => 'Users', 'action' => 'index'], ['class' => 'dropdown-item']) ?>
                            <?= $this->Html->link(__('Admin panel: Customers'), ['controller' => 'Admin\Customers', 'action' => 'index'], ['class' => 'dropdown-item']) ?>
                        <?php endif;?>
                        <div class="dropdown-divider"></div>
