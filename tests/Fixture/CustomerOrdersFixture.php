...
class CustomerOrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'customer_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'autoIncrement' => null],
        'order_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'customer_id' => 1,
                'order_date' => '2018-10-04 17:12:05',
                'created' => '2018-10-04 17:12:05',
                'modified' => '2018-10-04 17:12:05'
            ],
        ];
        parent::init();
    }
