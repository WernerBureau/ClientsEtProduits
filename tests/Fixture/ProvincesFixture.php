...
class ProvincesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'country_id_fk' => ['type' => 'foreign', 'columns' => ['country_id'], 'references' => ['countries', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-05 18:02:35',
                'modified' => '2018-11-05 18:02:35'
            ],
        ];
        parent::init();
    }
